...
$p = new Poll;
$p->question = "What should be worked on next?";	// Question displayed to the user
$p->returnToURL = "../poll.php";				// Specify the URL to return to for this poll; may be relative or absolute
$p->legend = "Next Thing";						// Form legend; leave empty for none
$p->control_type = $CONTROL_RADIOBUTTONS;		// Control type; $CONTROL_RADIOBUTTONS or $CONTROL_COMBOBOX
$p->add_value("1", "Traps");						// Poll value ID and a display string
$p->add_value("2", "Enemies");
$p->add_value("3", "Warrior Class");
$p->add_value("4", "Fixed number of levels in a dungeon");
